...
const NewsCards = () => {
  ...
  const fetchData = async () => {
    ...
    try {
      ...
      if (search) {
        apiUrl = `https://gnews.io/api/v4/search?q=${search}&sortby=publishedAt&lang=en&apikey=${key}`;
      } else {
        ...
        <div className="max-w-[85rem] mx-auto px-4 sm:px-6 lg:px-8 py-10 sm:py-24">
          <div className="text-center">
            ...
            <div className="mt-7 sm:mt-12 mx-auto max-w-xl relative">
              {/* Form */}
              <form>
                <div className="relative z-10 flex space-x-3 p-2 bg-white border rounded-lg shadow-lg shadow-gray-100 dark:bg-gray-800 dark:border-gray-700 dark:shadow-gray-900/[.2]">
